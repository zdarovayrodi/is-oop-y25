...
public class Test
{
    ...
    public void CanSaveBackupTaskState()
    {
        ...
        Saver<BackupTaskDecorator> saver = new Saver<BackupTaskDecorator>("/Users/zdarovayrodi/Documents/itmo-oop/Lab5/Backups.Extra.Test/backupObject.json", backupTask);
        saver.Save();
